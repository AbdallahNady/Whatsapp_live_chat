...
public class RequestFragment extends Fragment {
                                    ...
                                    if (type.equals("received")){
                                        UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                holder.userProfileStatus.setText("wants to conect with you");
                                                        ...
                                                        builder.setItems(options, new DialogInterface.OnClickListener() {
                                                            ...
                                                            public void onClick(DialogInterface dialog, final int i) {
                                                                ...
                                                                if (i == 0){
                                                                    ...
                                                                    ContactsRef.child(cuurentUserID).child(list_user_id).child("Contact")
                                                                            .setValue("Saved").addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                        @Override
                                                                        public void onComplete(@NonNull Task<Void> task) {
                                                                            if (task.isSuccessful()){
                                                                                ContactsRef.child(list_user_id).child(cuurentUserID).child("Contact")
                                                                                        .setValue("Saved").addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                    @Override
                                                                                    public void onComplete(@NonNull Task<Void> task) {
                                                                                        if (task.isSuccessful()){

                                                                                            ChatRequestRef.child(cuurentUserID).child(list_user_id)
                                                                                                    .removeValue()
                                                                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                        ...
                                                                                                        public void onComplete(@NonNull Task<Void> task) {
                                                                                                            if (task.isSuccessful()){
                                                                                                                ...
                                                                                                                ChatRequestRef.child(list_user_id).child(cuurentUserID)
                                                                                                                        .removeValue()
                                                                                                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                            @Override
                                                                                                                            public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                holder.userName.setText(requestUserName);
                                                holder.userProfileStatus.setText("you have sent a request to "+ requestUserName);
                                                                                                ...
                                                                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                    ...
                                                                                                    public void onComplete(@NonNull Task<Void> task) {
                                                                                                        if (task.isSuccessful()){
                                                                                                            ...
                                                                                                            Toast.makeText(getContext(), "you have cancelled Request...", Toast.LENGTH_SHORT).show();
                                                                                                        }
                                                                                                    }
                                                                                                });
                                                                                    }
    ...
    public static class RequestViewHolder extends RecyclerView.ViewHolder{
        ...
        public RequestViewHolder(@NonNull View itemView) {
            ...
            userProfileStatus = itemView.findViewById(R.id.user_stutas);
