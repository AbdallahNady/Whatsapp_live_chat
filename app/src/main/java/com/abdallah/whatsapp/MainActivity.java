...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToolbar = (Toolbar) findViewById(R.id.main_pag_toolbar);
        ...
        mytabLayout = (TabLayout) findViewById(R.id.mai_tabs);
    ...
    private void SendToSettingsnActiviy() {
        Intent settingsIntent = new Intent(MainActivity.this , SettingsActivity.class);
        startActivity(settingsIntent);
    }


    private void SendToSFindFriendsActiviy() {
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(MainActivity.this, groupName + " os Created Successfully...", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
