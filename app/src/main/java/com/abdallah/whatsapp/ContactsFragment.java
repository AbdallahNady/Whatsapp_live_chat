...
public class ContactsFragment extends Fragment {
    ...
    private DatabaseReference contactssRef, UsersRef;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        contactssRef = FirebaseDatabase.getInstance().getReference().child("Contacts").child(currentUserID);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions option =
                ...
                .setQuery(contactssRef, Contacts.class)
                .build();
        ...
        FirebaseRecyclerAdapter<Contacts, ContactsViewHolder> adapter =
                new FirebaseRecyclerAdapter<Contacts, ContactsViewHolder>(option) {
                    ...
                    protected void onBindViewHolder(@NonNull final ContactsViewHolder holder, int position, @NonNull Contacts model) {
                        String usetIds = getRef(position).getKey();
                        UsersRef.child(usetIds).addValueEventListener(new ValueEventListener() {
                            @Override
    ...
    public static class ContactsViewHolder extends RecyclerView.ViewHolder{
        ...
        public ContactsViewHolder(@NonNull View itemView) {
            ...
            onlineIcone = itemView.findViewById(R.id.user_online_satus);
        }
    }
